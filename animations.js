...
function initCustomCursor() {
    ...
    // CSS requerido para cursor:
    // #custom-cursor { position: fixed; width: 20px; height: 20px; border: 2px solid #3B82F6; border-radius: 50%; pointer-events: none; transform: translate(-50%, -50%); transition: transform 0.1s ease; z-index: 9999; }
}
...
function initProjectCarousel() {
    ...
    // Opcional: arrastre con el mouse
    let isDown = false;
    let startX;
    let scrollLeft;
